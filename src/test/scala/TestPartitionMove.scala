...
class TestPartitionMove extends FlatSpec with BeforeAndAfterAll{
  ...
  val t = new TestUtils("TestPartitionMoveUniq")
  t.setupTestEnv()
    ...
    Promotor.moveTablePartitions(t.db, "STORE_SALES_DLT", t.db, "STORE_SALES_SFCT", Seq("2019-10-31", "2019-12-31"), false, 1)
